...
from os import listdir, mkdir, remove, path, getcwd;
import sys
import shutil
import subprocess
...
def getRowWithGivenValue(filename, value, column=1):
    ...
    min_diff = 1e300; # hopefully this is enough for real use
...
def ls(dir_path, type="dir"):
  """ List files in a folder. Files and folders begin with dot will be ignored.
