...
"""
    ...
    events from hydro + IP-Glasma runs. The results format is the same
    as iS format
"""
...
EbeCollector().createDatabaseFromEventFolders(from_folder, subfolder_pattern, database_filename, collectMode="fromHydro_with_IP-Glasma")
