...
!----------- Initial profile related output starts here ----------------
     ...
     &     'results/ecc-init-r_power-', r_power, '.dat'
      ...
      Do NN = 1, 9
        ...
        End Do
        End Do
        Write (375,'(3E20.8)') -XN(NN)/Weight, -YN(NN)/Weight, ! Note that I use minor axis to define eccentricity
     &            sqrt(XN(NN)*XN(NN)+YN(NN)*YN(NN))/Weight
      End Do ! NN=1, 9
      Close(375)
      End Do ! r_power
 ...
 381    Format(6(E20.8))
     ...
     &     'results/ecc-init-sd-r_power-', r_power, '.dat'
      ...
      Do NN = 1, 9
        ...
        End Do
        End Do
        Write (379,'(3E20.8)') -XN(NN)/Weight, -YN(NN)/Weight, ! Note that I use minor axis to define eccentricity
     &            sqrt(XN(NN)*XN(NN)+YN(NN)*YN(NN))/Weight
      End Do ! NN=1, 9
      Close(379)
      End Do ! r_power
